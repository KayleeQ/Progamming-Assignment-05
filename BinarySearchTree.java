...
public class BinarySearchTree<E extends Comparable<E>> extends AbstractTree<E> {
    ...
    public boolean search(E e, int[] count) {
        ...
        return false;
    }// .....jia)))extra parameter in the search method to take in an count array.
    ...
    private ArrayList<E> preorderedList(TreeNode<E> left) {
...
//Add root element, recurrsively add lefts, recurrsively add rights
     ...
     * @return
     */
    public boolean sameTree(BinarySearchTree otherTreeRoot){
        return sameTree(this.root, otherTreeRoot.root);
    }//5.
    
        private boolean sameTree(TreeNode<E> Tree1, TreeNode<E> another){
        if (Tree1==null && another==null) return true;
        else{
            if (Tree1!=null&& another!=null){
                if(Tree1.element!=another.element) return false;
                return sameTree(Tree1.left, another.left) && sameTree(Tree1.right, another.right);
            }else return false;
        }
    }//5.
//    public boolean sameTree(BinarySearchTree tree1,BinarySearchTree tree2){
//        return sameTree(this.root,this.root);
//    }
//    privte boolean sameTree(TreeNoderoot1, TreeNode<E> root2){
//        if(this.root == null && this.root 2 == null){
//        return true;
//    }
//        else if(){
//        return;
